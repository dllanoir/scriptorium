...
(function() {
    ...
    // ==========================================
    const Config = {
        getSupabaseUrl: () => typeof window.SUPABASE_URL !== 'undefined' ? window.SUPABASE_URL : '__SUPABASE_URL__',
        getSupabaseKey: () => typeof window.SUPABASE_ANON_KEY !== 'undefined' ? window.SUPABASE_ANON_KEY : '__SUPABASE_ANON_KEY__'
    };

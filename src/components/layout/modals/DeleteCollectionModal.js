...
export function DeleteCollectionModal() {
    return `
    <div id="delete-collection-modal" class="fixed inset-0 bg-surface/80 dark:bg-black/80 backdrop-blur-2xl z-[999] hidden items-center justify-center p-4 transition-opacity duration-500 opacity-0">
